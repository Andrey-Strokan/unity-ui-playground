...
namespace Saritasa.Fader.Editor
{
    /// <summary>
    ...
    public class TunnelingVignetteControllerEditor : BaseInteractionEditor
    {
        ...
        {
            public readonly SerializedProperty fadeOpacity;
            ...
            {
                fadeOpacity = parameterProperties.FindPropertyRelative("fadeOpacity");
            ...
            {
                fadeOpacity.floatValue = VignetteParameters.Defaults.fadeOpacityDefault;
        ...
        protected static class Contents
        {
            ...
            /// <summary><see cref="GUIContent"/> for <see cref="VignetteParameters.fadeOpacity"/>.</summary>
            public static readonly GUIContent fadeOpacity = EditorGUIUtility.TrTextContent("Fade Opacity", "Opacity of sphere.");
        ...
        void DrawListElements(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (useOverrideParameters.boolValue)
            {
                ...
                {
                    y += height + k_Padding;
                    height = EditorGUI.GetPropertyHeight(parameters.fadeOpacity);
                    LayoutElement(new Rect(x, y, width, height), parameters.fadeOpacity, Contents.fadeOpacity);
        ...
        float GetElementHeight(int index)
        {
            ...
            if (!s_HeightsMeasured)
            {
                ...
                s_ExpandedHeight = s_UnexpandedHeight
                    + EditorGUI.GetPropertyHeight(parameters.fadeOpacity) + k_Padding
            ...
            if (m_CurrentParameters.isExpanded)
            {
                using (new EditorGUI.IndentLevelScope())
                {
                    using (new EditorGUI.DisabledScope(true))
                    {
                        ...
                        EditorGUILayout.PropertyField(m_CurrentParameterProperties.fadeOpacity, Contents.fadeOpacity);
        ...
        void DrawDefaultParameters()
        {
            ...
            if (m_DefaultParameters.isExpanded)
            {
                using (new EditorGUI.IndentLevelScope())
                {
                    EditorGUILayout.PropertyField(m_DefaultParameterProperties.fadeOpacity, Contents.fadeOpacity);
